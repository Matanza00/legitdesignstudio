        ...
        <div className="flex flex-1 flex-col min-w-0">
          <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b bg-background/80 px-4 backdrop-blur">
            ...
            <div className="relative hidden md:flex max-w-md flex-1">
              ...
              <Input placeholder="Search employees, payslips, expenses…" className="h-9 pl-9 bg-muted/40 border-transparent focus-visible:bg-card" />
            </div>
            <div className="ml-auto flex items-center gap-1.5">
              ...
              <div className="ml-1.5 flex items-center gap-2.5 pl-2.5 border-l">
